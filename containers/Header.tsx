      ...
      <div className="flex h-full w-2/4 items-center justify-center gap-4 max-md:w-4/6">
        <div className={`relative w-1/2 max-lg:${showAddress} flex gap-2`}>
          <div className="flex w-full">
            ...
            />
            <span className="grid h-10 w-10 place-items-center rounded-r-lg border-y border-r border-slate-300 bg-zinc-200">
              <XMarkIcon
        ...
        {status !== 1 ? (
          <DropdownMenu>
            ...
            <DropdownMenuContent className="mr-4 w-56 border border-black bg-zinc-200">
              <DropdownMenuGroup>
                <DropdownMenuItem
                  className="flex items-center focus:border-black cursor-pointer"
            ...
            {status !== 1 ? (
              ...
              <DropdownMenuGroup>
                ...
                {role > 1 && (
                  ...
                  >
                    <User className="mr-2 h-5 w-5"></User>
                    <span>{role == 2 ? "Page partenaire" : "Admin"}</span>
                  </DropdownMenuItem>
                )}
                <DropdownMenuItem
                  className="flex items-center cursor-pointer"
