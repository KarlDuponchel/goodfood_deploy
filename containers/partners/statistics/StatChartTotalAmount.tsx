...
import { useFetchTotalAmountByPeriod } from "@/hooks/reporting/use_fetch_total_amout_by_period";
...
type StatChartTotalAmountProps = {
  period: string;
  idRestaurant: number;
};

export const StatChartTotalAmount = ({
  period,
  idRestaurant,
}: StatChartTotalAmountProps) => {
  const totalAmount = useFetchTotalAmountByPeriod(period, idRestaurant);
        ...
        period ? (
          <ResponsiveContainer width="100%" height="100%">
            <LineChart
              width={400}
              height={200}
              data={totalAmount.data?.sort((a, b) =>
