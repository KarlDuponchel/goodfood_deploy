...
type ProductsCardByRestaurantProps = {
  /**
...
export const ProductsCardsByRestaurant: FunctionComponent<
  ProductsCardByRestaurantProps
> = ({ onUpdateCart, idRestaurant }) => {
  ...
  return (
    <>
      <div className="grid grid-cols-3 place-items-center gap-6 max-xl:grid-cols-4 max-lg:grid-cols-2 max-md:grid-cols-1">
        ...
        {products.data?.data.length !== 0 ? (
                ...
                <div className="relative h-5/6 w-full cursor-pointer">
                  <a href={`/products/${product.id}`}>
                    <Image
                      src={product.image}
                      alt={product.name}
                      className="rounded-t object-cover h-[220px] w-full"
                      width={500}
                      height={500}
                    />
                  </a>
          ...
          <div className="absolute top-1/2 text-2xl">
